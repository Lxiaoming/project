...
<div class="layui-fluid">        
    ...
    <div class="layui-input-block">
      <input type="radio"  name="manage_contractapprove_taxIncluded" value="1" title="含税" checked="">
	   ...
	   <div class="layui-form-item">
	    ...
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	       ...
	       <div class="layui-inline">
	       <input type="radio"  name="category" value="1" title="施工合同" lay-filter="chapCategory" checked="checked">
           <input type="radio"  name="category" value="2" title="供应商合同" lay-filter="chapCategory">
           <input type="radio"  name="category" value="3" title="合作合同" lay-filter="chapCategory">
...
$(document).ready(function() {
	...
	//展示历史记录
	  ...
	  // 监听事件,动态流程显示
		  form.on('radio(chapCategory)', function(data){
