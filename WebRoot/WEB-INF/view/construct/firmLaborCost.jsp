...
layui.use(['table','form','laypage','layer','laydate','jquery'], function(){
    ...
    table.render({
    elem: '#lay_table_user'
         ,url:'firmLaborCosts.do'
         ,toolbar: '#toolbarDemo'
         ,totalRow: true
    	 ,cols: [[ //标题栏
    	           
    	            {field: 'constuct_project_dep_name', title: '项目部', width: 80}
    	            ,{field: 'constuct_project_dep_leader', title: '项目负责人', width: 150,totalRowText: '合计'}
    	            ,{field: 'conAmount', title: '合同总金额', width: 100,totalRow: true}
       ...
       var $ = layui.$, active = {
	    ...
	    table.on('tool(demo)', function(obj){
	      ...
	      switch (obj.event) {
	         //查看
		  case 'detail':
			location.href = "firmLaborCostPro.do?" + $.param({
				'hr_attend_date' : data.hr_attend_date,
				'projectDep' : data.constuct_project_dep_id,
