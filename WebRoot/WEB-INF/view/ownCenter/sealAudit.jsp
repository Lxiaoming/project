  ...
  <div class="layui-form-item">
   ...
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="checkbox" name="own_seal_chapCategory" value="1" lay-skin="primary" title="公章">
      <input type="checkbox" name="own_seal_chapCategory" value="2" lay-skin="primary" title="业务章">
      <input type="checkbox" name="own_seal_chapCategory" value="3" lay-skin="primary" title="出图章" >
      <input type="checkbox" name="own_seal_chapCategory" value="4" lay-skin="primary" title="竣工章 ">
      <input type="checkbox" name="own_seal_chapCategory" value="5" lay-skin="primary" title="项目章">
    </div>
  </div>
  <div class="layui-form-item">
...
<script>
	...
	/* 	var historys = ${history}.history;
		...
		$("#own_seal_company").val(${seal.own_seal_company});
		category();
	 ...
	 function setUserName(data){
		...
		if (reason =='') {
     	...
     	if(type =='true' || type =='apply'){
     	  ...
     	  var arr=$("#form1").serialize()+"&userid="+userid+"&reason="+reason+"&taskid="+taskid+"&type="+type;
			$.ajax({
				type : 'POST',
				url : 'pass_seal.do',
				data : arr,
