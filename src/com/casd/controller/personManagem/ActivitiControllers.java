...
public class ActivitiControllers {
	...
	public Map<String, Object> findTaskList(HttpServletRequest request)
		...
		Map<String, Object> json = new HashMap<String, Object>();
	        ...
	        String fields=" DISTINCT RES.*, datas.illustrate,datas.applicant,d.name_  pdname,s.BUSINESS_KEY_";
	        ...
	        sbf.append(" LEFT JOIN act_hi_procinst s ON s.proc_inst_id_ = RES.PROC_INST_ID_");
