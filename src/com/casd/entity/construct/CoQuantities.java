...
public class CoQuantities implements Serializable{
	...
	private BigDecimal construct_project_quantities_num;     //主材数量
	private BigDecimal construct_project_quantities_auxiliaryNum;     //辅材数量
	...
	public BigDecimal getConstruct_project_quantities_auxiliaryNum() {
		return construct_project_quantities_auxiliaryNum;
	}

	public void setConstruct_project_quantities_auxiliaryNum(
			BigDecimal construct_project_quantities_auxiliaryNum) {
		this.construct_project_quantities_auxiliaryNum = construct_project_quantities_auxiliaryNum;
	}   
