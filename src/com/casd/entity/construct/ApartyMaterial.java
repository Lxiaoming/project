...
public class ApartyMaterial implements Serializable {
	...
	private Integer construct_Aparty_material_constructId;				//项目id
	...
	public Integer getConstruct_Aparty_material_constructId() {
		return construct_Aparty_material_constructId;
	}
	public void setConstruct_Aparty_material_constructId(
			Integer construct_Aparty_material_constructId) {
