...
public class Costapp implements Serializable {
	...
	private Integer costapp_id; 				//单据id 
	...
	private Integer costapp_status;		        //审核状态
	private Integer userid;	                    //申请人
	
	public Integer getCostapp_id() {
		return costapp_id;
	}
	public void setCostapp_id(Integer costapp_id) {
	...
	public Integer getCostapp_status() {
		return costapp_status;
	}
	public void setCostapp_status(Integer costapp_status) {
