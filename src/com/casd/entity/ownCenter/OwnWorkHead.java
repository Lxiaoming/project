...
public class OwnWorkHead implements Serializable{
	...
	private String own_workArrangHead_projectId; //项目id
	...
	public String getOwn_workArrangHead_projectId() {
		return own_workArrangHead_projectId;
	}
	public void setOwn_workArrangHead_projectId(
			String own_workArrangHead_projectId) {
		this.own_workArrangHead_projectId = own_workArrangHead_projectId;
	}
