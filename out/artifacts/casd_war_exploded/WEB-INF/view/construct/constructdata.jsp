	...
	<table id="materialListID" class="easyui-datagrid" title="请款进度" 
		...
		<thead>
			<tr>
				...
				<th
					data-options="field:'manage_reqfunds_ticketDate',width:80,align:'right',editor:'datebox',sortable: true">开票日期</th> 
				<th
					data-options="field:'manage_reqfunds_ticketAmount',width:80,align:'right',editor:'text' ">开票金额</th>
				<th
					data-options="field:'manage_reqfunds_receiveDate',width:80,align:'right'">收款日期</th>   
				<th
					data-options="field:'manage_reqfunds_receiveAmount',width:80,align:'right'">收款金额</th>
				<th
					data-options="field:'manage_reqfunds_remark',width:80,align:'right' ">备注</th> 
				<th
...
<div id="main" style=" float:right;width: 25%;height:500px;"></div>
	...
	/* 	
		...
		function onClickCell(index, field, cellData) {
			//收款金额，收款日期，备注在这个jsp中不能修改；
