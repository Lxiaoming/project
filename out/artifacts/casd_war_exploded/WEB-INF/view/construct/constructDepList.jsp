...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no">
				...
				<table id="data" title="" fit="true" 
					...
					<thead>
						<tr>
							...
							<th halign="center" field="conAmount" formatter="con_formatter"
								align="center" sortable="true" width="120px">合同总金额</th>
							<th halign="center" field="prutotal" formatter="pur_formatter"
								align="center" sortable="true" width="120px">采购成本</th>
							<th halign="center" field="workertotal" formatter="worker_formatter"
								align="center" sortable="true" width="120px">人工成本</th>			
	...
	<script type="text/javascript">
		...
		function operate_formatter(value, row, index) {
			if(row.constuct_project_dep_company!=null){
				var html = "";
		...
		function con_formatter(value, row, index){
			
			return  parseFloat(value).toFixed(2);
			
		}
		
		function pur_formatter(value, row, index){
			
			return  parseFloat(value).toFixed(2);
			
		}
		
		function worker_formatter(value, row, index){
